...
public class Pvr_UIPointer : MonoBehaviour {
    ...
    {
        return Input.GetMouseButton(0) || Input.GetKey(KeyCode.JoystickButton0) ||Pvr_UnitySDKAPI.Controller.UPvr_GetKey(Pvr_UnitySDKAPI.Controller.UPvr_GetMainHandNess(), Pvr_UnitySDKAPI.Pvr_KeyCode.TOUCHPAD);    
    }
